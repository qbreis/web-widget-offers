...
const getCrossSellingOld = (proposalsOffersArray, selectedOffer, wwo_strings, widgetDisplayOptions, proposalUrl) => {
    ...
    return `
        <h2>${wwo_strings['cross-selling-title']}:ZZZ</h2>
...
module.exports = { getCrossSellingOld };